...
<body style="background-color: #ffffff ;margin-top: 0;margin-bottom: 0;">
  ...
  <a class="home_b" href="physician_home.php">Home</a><a class="logout_b"  href="logout.php">Logout</a>
   ...
   <div class="myBox" style="width: 70%; height: 65vh; margin-left: 15%;background-color: #e6f2ff ;font-size: 20px;">
        ...
        <input id="med_form"  type="text" name="m_name" placeholder="Medicine name"><br><br>
        <label style="margin-left: 5%;">Description</label><br>
           <textarea id="med_textarea" name="des" rows="2" cols="70" placeholder="Enter Description"></textarea><br>
        <label style="margin-left: 5%;">Dose</label><br>
           <textarea id="med_textarea" name="dose" rows="2" cols="70" placeholder="Enter Dose"></textarea>
