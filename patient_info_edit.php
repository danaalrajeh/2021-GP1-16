    ...
    <form action="patient_info_edit_in.php" method="post">
      ...
      <div>
        <span id="p_span_info2">
            <input id="info_edit_form"  type="number" name="r_num" value="<?= !empty($p['r_num']) ? $p['r_num'] : '' ?>" placeholder="Relative's number" required>
        </span>
      </div>
      <div>
        <span id="p_span_info2">
...
<div>
        ...
        <span id="p_span_info">
         <?php echo ' <a id="btn_p_info" href="physical_activity.php?id='.$p['id'].'">Physical_Acvtivity</a>';?>
        </span> 
      </div>
      <br>
      <div>
        ...
        <span id="p_span_info" >
         <?php echo ' <a id="btn_p_info" href="alarming.php?id='.$p['id'].'">Cirtical_symptoms</a>';?>
