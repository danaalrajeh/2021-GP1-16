...
<body style="background-color: #ffffff;margin-top: 0;margin-bottom: 0;">
   ...
   <div class="myBox" style="width: 70%; height: 65vh; margin-left: 15%;background-color: #e6f2ff;font-size: 20px;">
    <?php
    echo '<h2 id="m_5">'.$m['m_name'].'</h2>
    <p id="m_5"><strong>Description</strong> </p>
    <textarea id="med_textarea" name="w3review" rows="3" cols="70" readonly>'.$m['descrption'].'
  </textarea>
  <p id="m_5"><strong>Dose</strong> </p>
    <textarea id="med_textarea" name="w3review" rows="3" cols="70" readonly>'.$m['dose'].' 
  </textarea>';
