 ...
 <img id="p_img" src="img\logo_f.png"  ALIGN="center"> <p id="doc_name">&nbsp;&nbsp;Dr. <?php echo $user['fname'];  ?></p>
  <a class="home_b" href="physician_home.php">Home</a><a class="logout_b"  href="logout.php">Logout</a>
   ...
   <div class="myBox" style="width: 70%; height: 65vh; margin-left: 15%;background-color: #e6f2ff;font-size: 20px;">
        ...
        <input id="med_form"  type="text" name="m_name" value="<?= !empty($m['m_name']) ? $m['m_name'] : '' ?>" placeholder="Medicine name"><br><br>
        <label style="margin-left: 5%;">Description</label><br>
      <input id="med_textarea" type="text" name="des" value="<?= !empty($m['descrption']) ? $m['descrption'] : '' ?>" placeholder="Enter Descrption">
           
        <label style="margin-left: 5%;">Dose</label><br>
         <input id="med_textarea" type="text" name="dose" value="<?= !empty($m['dose']) ? $m['dose'] : '' ?>" placeholder="Enter Dose">
